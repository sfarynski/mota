...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function recupData() {
      ...
      console.log("Nombre de posts pour la lightbox " + nb_total_posts);
    ...
    (function ($) {
      //$(document).ready(function () {
        ...
        $(".publication-list").click(function (e) {
          e.preventDefault();
          console.log("lightbox plein ecran");
        ...
        $(".lightbox__prev").click(function (e) {
          e.preventDefault();
          idPhotoNext = idPhoto;
          console.log("Photo précédente des "+nb_total_posts+" photos");
          if (idValue > 0) {
            idValue--;
          } else {
        ...
        $(".lightbox__next").click(function (e) {
          e.preventDefault();
          idPhotoNext = idPhoto;
          console.log("Photo suivantedes "+nb_total_posts+" photos");
