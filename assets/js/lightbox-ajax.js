...
document.addEventListener("DOMContentLoaded", function () {
  // console.log("Script lightbox lancé !!!");
      ...
      function recupData() {
        if (document.getElementById("common_posts") !== null) {
          total_posts = document.getElementById("common_posts").value;
          ...
          //console.log("contenu de total_posts: "+total_posts+"\n")
        }
      ...
      function recupIdData(arg) {
        ...
        for (let i = 0; i < nb_total_posts; i++) {
          ...
          //console.log("position: "+data[0].slice(`${position}`)+"\n");
  ...
  (function ($) {
    $(document).ready(function () {
      ...
      $(".openLightbox").click(function (e) {
        console.log("Script lightbox-ajax lancé !!!");
        const gallery  = document.querySelectorAll(".news-info");
        console.log("Nombre de photo dans la gallerie " + gallery.length);
        e.preventDefault();
